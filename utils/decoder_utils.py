...
class MultipleVectorGenerator:
    ...
    def __call__(self, start_T, end_T, k=0, r=0):
        texture_number = (start_T // self.video_length) % self.n_examples
        frame_number = start_T % self.video_length + self.video_length * (start_T // self.video_length // self.n_examples)
